...
export function buildSettingsTooltipCatalogEvent(ids: SettingsCardTemplateIdsEvent): Record<string, string> {
  return {
    ...
    [ids.tabMainId]: "查看主设置。",
    [ids.tabSkillId]: "查看技能设置。",
    [ids.tabRuleId]: "查看规则设置。",
    [ids.tabAboutId]: "查看插件信息。",
    [ids.enabledId]: "事件骰子系统总开关。",
    [ids.scopeId]: "设置事件作用范围。",
    [ids.ruleId]: "发送前自动加规则。",
    [ids.aiRollModeId]: "让 AI 决定自动或手动掷骰。",
    ...
    [ids.listOutcomePreviewId]: "在列表里预览结果分支。",
    ...
    [ids.skillEditorOpenId]: "打开技能编辑器。",
    [ids.skillPresetCreateId]: "新建技能预设。",
    [ids.skillPresetDeleteId]: "删除当前技能预设。",
    [ids.skillPresetRestoreDefaultId]: "恢复默认预设。",
    [ids.skillPresetNameId]: "输入预设名称。",
    [ids.skillPresetRenameId]: "保存预设名称。",
    [ids.skillAddId]: "新增一行技能。",
    [ids.skillSaveId]: "保存技能表。",
    [ids.skillResetId]: "清空技能草稿。",
    [ids.skillImportToggleId]: "展开或收起导入区。",
    [ids.skillImportApplyId]: "应用导入内容。",
    [ids.skillExportId]: "导出技能 JSON。",
    [ids.skillTextId]: "粘贴技能 JSON。",
    [ids.ruleSaveId]: "保存补充规则。",
    [ids.ruleResetId]: "清空补充规则。",
    [ids.ruleTextId]: "编辑补充规则文本。",
    [ids.statusAddId]: "新增一行状态。",
    [ids.statusSaveId]: "保存状态。",
    [ids.statusResetId]: "重置状态草稿。",
