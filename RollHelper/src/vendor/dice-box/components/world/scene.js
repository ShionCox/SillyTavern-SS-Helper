...
function createScene(options) {
  ...
  scene.pointerMovePredicate = (mesh) => mesh?.isPickable === true;
  scene.pointerDownPredicate = (mesh) => mesh?.isPickable === true;
  scene.pointerUpPredicate = (mesh) => mesh?.isPickable === true;
