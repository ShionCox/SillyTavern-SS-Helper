...
function createWorkbenchState(): WorkbenchState {
    return {
        ...
        memoryFilterUnknownPolicy: 'memory',
        memoryFilterMode: 'xml',
        memoryFilterRules: [],
        memoryFilterCleanupTrimWhitespace: true,
        memoryFilterCleanupStripWrapper: true,
        memoryFilterCleanupDropEmptyBlocks: true,
        memoryFilterCleanupMinBlockLength: '0',
        memoryFilterCleanupMaxBlockLength: '1200',
    };
}
