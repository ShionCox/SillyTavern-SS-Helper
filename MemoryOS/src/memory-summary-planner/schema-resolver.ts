...
const BUILTIN_SCHEMA_FIELDS: Record<string, string[]> = {
    ...
    relationship: ['title', 'summary', 'trust', 'affection', 'tension', 'participants', 'tags', 'fields.relationTag', 'fields.state', 'fields.sourceActorKey', 'fields.targetActorKey'],
    task: ['title', 'summary', 'fields.objective', 'fields.status', 'fields.route', 'fields.nextStep', 'fields.goal', 'importance', 'tags'],
    open_thread: ['title', 'summary', 'fields.question', 'fields.status', 'fields.clue', 'fields.nextStep', 'importance', 'tags'],
